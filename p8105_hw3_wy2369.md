...
**snow**, **snwd**, **tmax** and **tmin** into numeric variables. Also
convert the unit of tmax and tmin to Degree C.
...
prcp(mm), snow(mm), snwd(mm), tmax(degree C), and tmin(degree C).
...
in each station across years. Is there any observable / interpretable
