...
Now there are **`r nrow(ny_noaa_df)`** rows and **`r ncol(ny_noaa_df)`** columns in the `ny_noaa_df` dataset. Variables are **`r ncol(ny_noaa_df)`** which include id, year, month, day, prcp(tenths of mm), snow(mm), snwd(mm), tmax(tenths of degree C), and tmin(tenths of degree C).   
